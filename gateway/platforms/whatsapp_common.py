...
class WhatsAppBehaviorMixin:
    ...
    def _effective_reply_prefix(self) -> str:
        ...
        Works in ALL modes (self-chat and multi-device). Subclasses that
        don't have a self-chat concept (the Cloud API adapter) can override
        this to always return ``""`` or apply a different policy.
        """
    ...
    def _outgoing_chunk_limit(self) -> int:
        """Reserve room for the reply prefix when it will actually be used."""
